import{u,j as i,b as xe,r as p,c as vn,f as Pe,d as He,e as Lt,M as It,g as $t,h as kn,i as En,k as jn,l as tt,R as Mn,m as Sn,n as Pn,T as Tn,o as ve,p as De,_ as G,q as Ne,s as _e,t as me,v as M,w as xt,x as Be,y as te,z as Ae,A as ae,B as K,C as mt,D as Me,E as gt,F as bt,G as Cn,H as Dn,I as zt,J as Ht,K as Y,L as Fn,N as On,O as Rn,P as Wn,Q as Nn}from"./index-7dc8fad8.js";import{c as _n,a as Bn,b as Ye,u as An}from"./index.esm-2d7d25f3.js";import{Q as Ln,B as qe}from"./react-toastify.esm-a68e1654.js";function In(e){const t=e.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}const $n=u.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Pa=({dayInfo:e})=>{const{data:t,dailyNorma:n,percentage:r,totalRecords:o}=e;return i.jsxs(Ma,{children:[i.jsx(Sa,{children:ke(t,"dd, MMMM")}),i.jsxs(Je,{children:["Daily norma:",i.jsxs("span",{children:[n," L"]})]}),i.jsxs(Je,{children:["Fulfillment of the daily norm:",i.jsxs("span",{children:[r,"%"]})]}),i.jsxs(Je,{children:["How many servings of water:",i.jsx("span",{children:o})]})]})},Ta=Y.div`
    width: 264px;
...
`,_a=()=>{const e=xe(),[t,n]=p.useState(new Date),[r,o]=p.useState(!0),[a,s]=p.useState(null),[c,l]=p.useState(null),{monthStats:d,waterRecords:f}=Le(),g=!!a,h=pi("(min-width:768px)"),y=Ze(t),x=Ue(t),w=ao({start:y,end:x}),j=x.getDate(),E=p.useMemo(()=>w.map(b=>{const D=ke(b,"yyyy-MM-dd");return{day:si(b),isToday:ci(b),fullDate:D}}),[w]),C=()=>{n(b=>Ze(kt(b,-1)))},m=()=>{n(b=>{const D=kt(b,1);return Ue(D)})},v=b=>{const D=b.target.value,k=R(d,D);l(k),s(b.currentTarget)},S=()=>{s(null)};p.useEffect(()=>{const b=new Date,D=Ze(b),k=Ue(b);o(li(t,{start:D,end:k}))},[t]),p.useEffect(()=>{e(Fn(ke(t,"yyyy-MM-dd")))},[e,t]);const R=(b,D)=>{const[k]=b.filter(O=>O.date===D);if(k){const O=(k.percentage/10).toFixed(1)*10>100?100:(k.percentage/10).toFixed(1)*10;return{data:t,dailyNorma:O===0?1.5:k.dailyNorma/1e3,percentage:ke(t,"yyyy-MM-dd")===D?f.percentageOfWaterConsumption:O,totalRecords:k.totalRecords}}else return{data:t,dailyNorma:1.5,percentage:0,totalRecords:0}};return i.jsxs(Ta,{children:[i.jsxs(Ca,{children:[i.jsx("h2",{children:"Month"}),i.jsxs(Da,{children:[i.jsx(_t,{onClick:C,children:i.jsx(Bt,{children:i.jsx(xn,{})})}),i.jsx(Fa,{children:ke(t,"MMMM yyyy")}),i.jsx(_t,{onClick:m,disabled:r,children:i.jsx(Bt,{isCurrentMonth:r,children:i.jsx(fn,{})})})]})]}),i.jsx(Oa,{lastDayNumber:j,children:E.map(b=>{const D=R(d,b.fullDate);return i.jsxs(Ra,{children:[i.jsx(Wa,{percentage:D.percentage,isToday:b.isToday,"aria-owns":g?"mouse-over-popover":void 0,"aria-haspopup":"true",onMouseEnter:v,onMouseLeave:S,value:b.fullDate,children:b.day}),i.jsxs(Na,{children:[D.percentage,"%"]})]},b.day)})}),i.jsx(ba,{id:"mouse-over-popover",sx:{pointerEvents:"none"},open:g,anchorEl:a,anchorOrigin:{vertical:"top",horizontal:"right"},transformOrigin:{vertical:"bottom",horizontal:h?"left":"center"},onClose:S,disableRestoreFocus:!0,children:i.jsx(Pa,{dayInfo:c})})]})};u.div`
...
cursor:pointer;
outline:none;
background-color: transparent`,Va=u.p`
font-family: Roboto;
font-size: 18px;
font-weight: 400;
line-height: 24px;
...
text-align: center;
color:#407BFF;
`,gs=({isOpen:e,onClose:t,recordData:n})=>{const{amountWater:r,date:o,_id:a}=n,s=xe(),[c,l]=p.useState(r),[d,f]=p.useState(w()),g=()=>{l(k=>k+50)},h=()=>{c>=50&&l(k=>k-50)},y=()=>{const[k,O]=d.split(":"),$=new Date;$.setUTCHours(k,O);const B=$.toISOString();s(On({id:a,amountWater:c,date:B})),s(Pe(!0)),t(),f(w())},x=k=>{const O=parseInt(k.target.value);l(O)};function w(){const k=new Date(o),O=k.getUTCHours().toString().padStart(2,"0"),$=k.getUTCMinutes().toString().padStart(2,"0");return`${O}:${$}`}if(p.useEffect(()=>{const k=O=>{O.key==="Escape"&&t()};return e&&document.addEventListener("keydown",k),()=>{document.removeEventListener("keydown",k)}},[e,t]),e===!1)return null;const C=n.date.toLocaleString(),m=new Date(C),v=m.getUTCHours(),S=m.getUTCMinutes(),R=S<10?"0"+S:S,b=v<10?"0"+v:v,D=v>=12?"PM":"AM";return i.jsx(bn,{children:i.jsxs(ns,{children:[i.jsxs(wn,{children:[i.jsx(yn,{children:"Edit the entered amount of water"}),i.jsx(at,{onClick:t,children:i.jsx(it,{})})]}),i.jsxs(rs,{children:[i.jsxs(os,{children:[i.jsx(gn,{children:i.jsx(es,{})}),i.jsxs(mn,{children:[i.jsxs(is,{children:[r," ml"]}),i.jsxs(as,{children:[b,":",R," ",D]})]})]}),i.jsxs("div",{children:[i.jsx(ss,{children:"Correct entered data:"}),i.jsx(et,{children:"Amount of water:"}),i.jsxs(Vt,{children:[i.jsx(Ut,{onClick:h,children:i.jsx(Yt,{})}),i.jsx(Gt,{children:i.jsxs(Qt,{children:[c," ml"]})}),i.jsx(Zt,{onClick:g,children:i.jsx(qt,{})})]})]}),i.jsxs("div",{children:[i.jsx(et,{children:"Recording time:"}),i.jsx(Xt,{type:"time",step:300,value:d,onChange:k=>f(k.target.value)})]}),i.jsxs("div",{children:[i.jsx(et,{children:"Enter the value of the water used:"}),i.jsx(Kt,{type:"number",value:c,onChange:x})]}),i.jsxs(cs,{children:[i.jsxs(Jt,{children:[c," ml"]}),i.jsx(ls,{onClick:y,children:"Save"})]})]})]})})},bs=({isOpen:e,onClose:t,recordData:n})=>{const r=xe();if(e===!1)return null;const o=()=>{const a=n._id;r(Rn(a)),r(Pe(!0)),t()};return i.jsx("div",{children:i.jsx(bn,{children:i.jsxs(ds,{children:[i.jsxs(wn,{children:[i.jsx(yn,{children:"Delete entry"}),i.jsx(at,{onClick:t,children:i.jsx(it,{})})]}),i.jsx(us,{children:"Are you sure you want to delete the entry?"}),i.jsxs(ps,{children:[i.jsx(hs,{children:i.jsx(xs,{onClick:o,children:"Delete"})}),i.jsx(fs,{onClick:t,children:i.jsx(ms,{children:"Cancel"})})]})]})})})},ws=()=>{const[e,t]=p.useState(!1),[n,r]=p.useState(!1),[o,a]=p.useState(!1),[s,c]=p.useState(null),{waterRecords:l}=Le().waterRecords,d=()=>{t(!0)},f=()=>{t(!1)},g=E=>{c(E),r(!0)},h=()=>{r(!1)},y=E=>{a(!0),c(E)},x=()=>{a(!1)},w=()=>{if(!(!l||l.length===0))return l.map(E=>{const v=E.date.toLocaleString(),S=new Date(v),R=S.getUTCHours(),b=S.getUTCMinutes(),D=b<10?"0"+b:b,k=R<10?"0"+R:R;return i.jsxs($a,{children:[i.jsxs(za,{children:[i.jsx(gn,{children:i.jsx(Ja,{})}),i.jsxs(mn,{children:[i.jsxs(Va,{children:[E.amountWater," ml"]}),i.jsxs(Ua,{children:[k,":",D]})]})]}),i.jsxs(Ha,{children:[i.jsx(At,{children:i.jsx(Xa,{onClick:()=>g(E)})}),i.jsx(At,{children:i.jsx(Ka,{onClick:()=>y(E)})})]})]},E._id)})},j=()=>i.jsx(La,{children:i.jsx(Ia,{children:i.jsx(w,{})})});return i.jsxs("div",{children:[i.jsxs(Ba,{children:[i.jsx(Aa,{children:"Today"}),i.jsx(j,{}),i.jsxs(Za,{onClick:d,children:[i.jsx(Ga,{children:i.jsx(ts,{})}),i.jsx(Qa,{children:"Add water"})]})]}),n&&i.jsx(gs,{isOpen:n,onClose:h,recordData:s}),i.jsx(en,{isOpen:e,onClose:f}),o&&i.jsx(bs,{isOpen:o,onClose:x,recordData:s})]})},ys="https://bekhuriy.github.io/WaterTracker/assets/Bubbles_bg_main_desk-ffd148af.svg",vs="https://bekhuriy.github.io/WaterTracker/assets/Bubbles_bg_home_tablet-f54d97ba.svg",ks="https://bekhuriy.github.io/WaterTracker/assets/Bubbles_bg_home_mob-0163f2d5.svg",Es=u.div`
  // position: relative;
...
`,Fs=()=>{const e=xe(),t=Le().forceRender;return p.useEffect(()=>{e(Wn()),e(Nn()),t&&e(Pe(!1))},[t,e]),i.jsx(Es,{children:i.jsx(js,{children:i.jsxs(Ms,{children:[i.jsxs(Ss,{children:[i.jsx(Xr,{}),i.jsx(lr,{})]}),i.jsxs(Ps,{children:[i.jsx(ws,{}),i.jsx(_a,{})]})]})})})};export{Fs as default};
